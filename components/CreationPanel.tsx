...
interface CreationPanelProps {
  onGenerate: (html: string, css: string, js: string, prompt: string) => void;
}
...
const CreationPanel: React.FC<CreationPanelProps> = ({ onGenerate }) => {
  ...
  const handleTryDemo = () => {
    onGenerate(sample.html, sample.css, sample.js, sample.prompt);
  };
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <textarea
                ...
                placeholder="例如：'创建一个关于可再生能源优势的5页演示文稿。包括一个标题页，一个引言，一个比较太阳能和风能的柱状图页，一个总结和一个感谢页。'"
