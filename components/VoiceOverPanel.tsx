...
const VoiceOverPanel: React.FC<VoiceOverPanelProps> = ({ htmlContent, originalPrompt, onNavigateToSlide, onScriptsGenerated, onAudioGenerated }) => {
    ...
    const handleGenerateScripts = async () => {
        ...
        setError(null);
        try {
            const generatedScripts = await generateNarrationScripts(htmlContent, originalPrompt);
